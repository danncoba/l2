...
def upgrade() -> None:
    op.add_column('matrix_chats', sa.Column('timespan_start', sa.BigInteger, nullable=True))
    op.add_column('matrix_chats', sa.Column('timespan_end', sa.BigInteger, nullable=True))
